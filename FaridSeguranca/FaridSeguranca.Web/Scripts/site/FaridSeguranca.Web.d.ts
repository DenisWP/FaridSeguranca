...
declare namespace FaridSeguranca.Administration {
}
declare namespace FaridSeguranca.Administration {
...
declare namespace FaridSeguranca.BasicSamples {
...
declare namespace FaridSeguranca.Common.Pages {
...
declare namespace FaridSeguranca.Common {
...
declare namespace FaridSeguranca.Default {
}
declare namespace FaridSeguranca.Default {
...
declare namespace FaridSeguranca.Default {
    namespace EmpresaService {
        ...
        const enum Methods {
            Create = "Default/Empresa/Create",
            Update = "Default/Empresa/Update",
            Delete = "Default/Empresa/Delete",
            Retrieve = "Default/Empresa/Retrieve",
            List = "Default/Empresa/List"
        }
    }
}
declare namespace FaridSeguranca.Default {
...
declare namespace FaridSeguranca.Default {
    ...
    class ProblemaForm extends Serenity.PrefixedContext {
        static formKey: string;
        private static init;
        constructor(prefix: string);
    }
...
declare namespace FaridSeguranca.Default {
    ...
    namespace ProblemaRow {
        const idProperty = "ProblemaId";
        const nameProperty = "Relatado";
        const localTextPrefix = "Default.Problema";
        const enum Fields {
...
declare namespace FaridSeguranca.Default {
    namespace ProblemaService {
        const baseUrl = "Default/Problema";
        function Create(request: Serenity.SaveRequest<ProblemaRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<ProblemaRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<ProblemaRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<ProblemaRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        const enum Methods {
...
declare namespace FaridSeguranca.Default {
    interface RelatoForm {
        TipoRelato: Serenity.StringEditor;
    }
    class RelatoForm extends Serenity.PrefixedContext {
        static formKey: string;
        private static init;
        constructor(prefix: string);
    }
...
declare namespace FaridSeguranca.Default {
    ...
    namespace RelatoRow {
        const idProperty = "Id";
        const nameProperty = "TipoRelato";
        const localTextPrefix = "Default.Relato";
        const enum Fields {
            Id = "Id",
...
declare namespace FaridSeguranca.Default {
    namespace RelatoService {
        const baseUrl = "Default/Relato";
        function Create(request: Serenity.SaveRequest<RelatoRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<RelatoRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<RelatoRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<RelatoRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        const enum Methods {
...
declare namespace FaridSeguranca {
...
declare namespace FaridSeguranca.Membership {
...
declare namespace FaridSeguranca.Northwind {
}
declare namespace FaridSeguranca.Northwind {
...
declare namespace FaridSeguranca.LanguageList {
    function getValue(): string[][];
}
declare namespace FaridSeguranca.ScriptInitialization {
}
declare namespace FaridSeguranca.Administration {
...
declare namespace FaridSeguranca.DialogUtils {
...
declare namespace FaridSeguranca.Default {
    class ProblemaDialog extends Serenity.EntityDialog<ProblemaRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected getService(): string;
        protected form: ProblemaForm;
    }
}
declare namespace FaridSeguranca.Default {
    class ProblemaGrid extends Serenity.EntityGrid<ProblemaRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof ProblemaDialog;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
        constructor(container: JQuery);
...
declare namespace FaridSeguranca.Default {
    class RelatoDialog extends Serenity.EntityDialog<RelatoRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected getService(): string;
        protected form: RelatoForm;
    }
}
declare namespace FaridSeguranca.Default {
    class RelatoGrid extends Serenity.EntityGrid<RelatoRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof RelatoDialog;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
        constructor(container: JQuery);
...
declare namespace FaridSeguranca.Authorization {
...
declare namespace FaridSeguranca.BasicSamples.DialogBoxes {
