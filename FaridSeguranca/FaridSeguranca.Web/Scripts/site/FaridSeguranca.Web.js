...
(function (FaridSeguranca) {
    ...
    })(Administration = FaridSeguranca.Administration || (FaridSeguranca.Administration = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Administration;
    (function (Administration) {
...
(function (FaridSeguranca) {
    ...
    })(BasicSamples = FaridSeguranca.BasicSamples || (FaridSeguranca.BasicSamples = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = FaridSeguranca.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = FaridSeguranca.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = FaridSeguranca.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (FaridSeguranca) {
    ...
    })(Common = FaridSeguranca.Common || (FaridSeguranca.Common = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Common;
...
(function (FaridSeguranca) {
    ...
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Default;
...
(function (FaridSeguranca) {
    var Default;
    (function (Default) {
        var ProblemaForm = /** @class */ (function (_super) {
            __extends(ProblemaForm, _super);
            function ProblemaForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            ProblemaForm.formKey = 'Default.Problema';
            return ProblemaForm;
        }(Serenity.PrefixedContext));
        Default.ProblemaForm = ProblemaForm;
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    ...
    (function (Default) {
        ...
        (function (ProblemaRow) {
            ProblemaRow.idProperty = 'ProblemaId';
            ProblemaRow.nameProperty = 'Relatado';
            ProblemaRow.localTextPrefix = 'Default.Problema';
        })(ProblemaRow = Default.ProblemaRow || (Default.ProblemaRow = {}));
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    ...
    (function (Default) {
        ...
        (function (ProblemaService) {
            ProblemaService.baseUrl = 'Default/Problema';
            [
                'Create',
                'Update',
                'Delete',
                ...
                ProblemaService[x] = function (r, s, o) {
                    return Q.serviceRequest(ProblemaService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(ProblemaService = Default.ProblemaService || (Default.ProblemaService = {}));
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Default;
    (function (Default) {
        var RelatoForm = /** @class */ (function (_super) {
            __extends(RelatoForm, _super);
            function RelatoForm(prefix) {
                var _this = _super.call(this, prefix) || this;
                if (!RelatoForm.init) {
            ...
            RelatoForm.formKey = 'Default.Relato';
            return RelatoForm;
        }(Serenity.PrefixedContext));
        Default.RelatoForm = RelatoForm;
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    ...
    (function (Default) {
        var RelatoRow;
        (function (RelatoRow) {
            RelatoRow.idProperty = 'Id';
            RelatoRow.nameProperty = 'TipoRelato';
            RelatoRow.localTextPrefix = 'Default.Relato';
        })(RelatoRow = Default.RelatoRow || (Default.RelatoRow = {}));
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    ...
    (function (Default) {
        var RelatoService;
        (function (RelatoService) {
            RelatoService.baseUrl = 'Default/Relato';
            [
                'Create',
                'Update',
                'Delete',
                ...
                RelatoService[x] = function (r, s, o) {
                    return Q.serviceRequest(RelatoService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(RelatoService = Default.RelatoService || (Default.RelatoService = {}));
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    ...
    })(Membership = FaridSeguranca.Membership || (FaridSeguranca.Membership = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Membership;
...
(function (FaridSeguranca) {
    ...
    })(Northwind = FaridSeguranca.Northwind || (FaridSeguranca.Northwind = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Northwind;
...
(function (FaridSeguranca) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'FaridSeguranca.Northwind.Gender', 'FaridSeguranca.Northwind.Entities.Gender');
    })(Northwind = FaridSeguranca.Northwind || (FaridSeguranca.Northwind = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
...
(function (FaridSeguranca) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = FaridSeguranca.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = FaridSeguranca.LanguageList || (FaridSeguranca.LanguageList = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
...
(function (FaridSeguranca) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('FaridSeguranca');
        Serenity.EntityDialog.defaultLanguageList = FaridSeguranca.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = FaridSeguranca.ScriptInitialization || (FaridSeguranca.ScriptInitialization = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Administration;
...
(function (FaridSeguranca) {
    ...
    FaridSeguranca.BasicProgressDialog = BasicProgressDialog;
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new FaridSeguranca.BasicProgressDialog();
...
(function (FaridSeguranca) {
    ...
    })(DialogUtils = FaridSeguranca.DialogUtils || (FaridSeguranca.DialogUtils = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Common;
...
(function (FaridSeguranca) {
    ...
    FaridSeguranca.StaticTextBlock = StaticTextBlock;
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Common;
...
(function (FaridSeguranca) {
    var Default;
    (function (Default) {
        var ProblemaDialog = /** @class */ (function (_super) {
            __extends(ProblemaDialog, _super);
            function ProblemaDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Default.ProblemaForm(_this.idPrefix);
                return _this;
            }
            ProblemaDialog.prototype.getFormKey = function () { return Default.ProblemaForm.formKey; };
            ProblemaDialog.prototype.getIdProperty = function () { return Default.ProblemaRow.idProperty; };
            ProblemaDialog.prototype.getLocalTextPrefix = function () { return Default.ProblemaRow.localTextPrefix; };
            ProblemaDialog.prototype.getNameProperty = function () { return Default.ProblemaRow.nameProperty; };
            ProblemaDialog.prototype.getService = function () { return Default.ProblemaService.baseUrl; };
            ProblemaDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], ProblemaDialog);
            return ProblemaDialog;
        }(Serenity.EntityDialog));
        Default.ProblemaDialog = ProblemaDialog;
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Default;
    (function (Default) {
        var ProblemaGrid = /** @class */ (function (_super) {
            __extends(ProblemaGrid, _super);
            function ProblemaGrid(container) {
                return _super.call(this, container) || this;
            }
            ProblemaGrid.prototype.getColumnsKey = function () { return 'Default.Problema'; };
            ProblemaGrid.prototype.getDialogType = function () { return Default.ProblemaDialog; };
            ProblemaGrid.prototype.getIdProperty = function () { return Default.ProblemaRow.idProperty; };
            ProblemaGrid.prototype.getLocalTextPrefix = function () { return Default.ProblemaRow.localTextPrefix; };
            ProblemaGrid.prototype.getService = function () { return Default.ProblemaService.baseUrl; };
            ProblemaGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], ProblemaGrid);
            return ProblemaGrid;
        }(Serenity.EntityGrid));
        Default.ProblemaGrid = ProblemaGrid;
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Default;
    (function (Default) {
        var RelatoDialog = /** @class */ (function (_super) {
            __extends(RelatoDialog, _super);
            function RelatoDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Default.RelatoForm(_this.idPrefix);
                return _this;
            }
            RelatoDialog.prototype.getFormKey = function () { return Default.RelatoForm.formKey; };
            RelatoDialog.prototype.getIdProperty = function () { return Default.RelatoRow.idProperty; };
            RelatoDialog.prototype.getLocalTextPrefix = function () { return Default.RelatoRow.localTextPrefix; };
            RelatoDialog.prototype.getNameProperty = function () { return Default.RelatoRow.nameProperty; };
            RelatoDialog.prototype.getService = function () { return Default.RelatoService.baseUrl; };
            RelatoDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], RelatoDialog);
            return RelatoDialog;
        }(Serenity.EntityDialog));
        Default.RelatoDialog = RelatoDialog;
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var Default;
    (function (Default) {
        var RelatoGrid = /** @class */ (function (_super) {
            __extends(RelatoGrid, _super);
            function RelatoGrid(container) {
                return _super.call(this, container) || this;
            }
            RelatoGrid.prototype.getColumnsKey = function () { return 'Default.Relato'; };
            RelatoGrid.prototype.getDialogType = function () { return Default.RelatoDialog; };
            RelatoGrid.prototype.getIdProperty = function () { return Default.RelatoRow.idProperty; };
            RelatoGrid.prototype.getLocalTextPrefix = function () { return Default.RelatoRow.localTextPrefix; };
            RelatoGrid.prototype.getService = function () { return Default.RelatoService.baseUrl; };
            RelatoGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RelatoGrid);
            return RelatoGrid;
        }(Serenity.EntityGrid));
        Default.RelatoGrid = RelatoGrid;
    })(Default = FaridSeguranca.Default || (FaridSeguranca.Default = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                FaridSeguranca.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(FaridSeguranca.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(FaridSeguranca.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(FaridSeguranca.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        FaridSeguranca.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: FaridSeguranca.Authorization.userDefinition.DisplayName,
...
(function (FaridSeguranca) {
    ...
    (function (Northwind) {
        ...
        }(FaridSeguranca.Common.GridEditorDialog));
...
(function (FaridSeguranca) {
    ...
    (function (Northwind) {
        ...
        }(FaridSeguranca.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return FaridSeguranca.LanguageList.getValue();
            };
...
(function (FaridSeguranca) {
    ...
    })(Authorization = FaridSeguranca.Authorization || (FaridSeguranca.Authorization = {}));
})(FaridSeguranca || (FaridSeguranca = {}));
var FaridSeguranca;
(function (FaridSeguranca) {
    var BasicSamples;
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(FaridSeguranca.Northwind.ProductDialog));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(FaridSeguranca.Northwind.ProductGrid));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: FaridSeguranca.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: FaridSeguranca.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new FaridSeguranca.Northwind.OrderDialog();
                        ...
                        var chai = FaridSeguranca.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = FaridSeguranca.Northwind.EmployeeRow.getLookup().items
        ...
        }(FaridSeguranca.Northwind.OrderGrid));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(FaridSeguranca.Northwind.OrderDialog));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    FaridSeguranca.Northwind.CategoryService.Retrieve({
        ...
        }(FaridSeguranca.Northwind.CategoryDialog));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(FaridSeguranca.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(FaridSeguranca.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new FaridSeguranca.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                FaridSeguranca.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(FaridSeguranca.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    FaridSeguranca.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(FaridSeguranca.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(FaridSeguranca.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    FaridSeguranca.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return FaridSeguranca.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return FaridSeguranca.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return FaridSeguranca.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return FaridSeguranca.Northwind.OrderService.baseUrl; };
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(FaridSeguranca.Northwind.SupplierDialog));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(FaridSeguranca.Northwind.SupplierGrid));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    FaridSeguranca.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(FaridSeguranca.Northwind.CustomerDialog));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(FaridSeguranca.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = FaridSeguranca.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return FaridSeguranca.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return FaridSeguranca.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new FaridSeguranca.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(FaridSeguranca.Northwind.OrderDetailDialog));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(FaridSeguranca.Northwind.OrderDetailsEditor));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return FaridSeguranca.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return FaridSeguranca.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return FaridSeguranca.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return FaridSeguranca.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return FaridSeguranca.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(FaridSeguranca.Common.BulkServiceAction));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return FaridSeguranca.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return FaridSeguranca.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return FaridSeguranca.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return FaridSeguranca.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(FaridSeguranca.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new FaridSeguranca.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new FaridSeguranca.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new FaridSeguranca.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (FaridSeguranca) {
    ...
    FaridSeguranca.SelectableEntityGrid = SelectableEntityGrid;
})(FaridSeguranca || (FaridSeguranca = {}));
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return FaridSeguranca.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return FaridSeguranca.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return FaridSeguranca.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return FaridSeguranca.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(FaridSeguranca.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = FaridSeguranca.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            FaridSeguranca.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return FaridSeguranca.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return FaridSeguranca.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return FaridSeguranca.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return FaridSeguranca.Northwind.ProductService.baseUrl; };
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return FaridSeguranca.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return FaridSeguranca.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return FaridSeguranca.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return FaridSeguranca.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return FaridSeguranca.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return FaridSeguranca.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (FaridSeguranca) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return FaridSeguranca.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return FaridSeguranca.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return FaridSeguranca.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=FaridSeguranca.Web.js.map