...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Default
        {
            ...
            {
                public const string EmpresaIndex = "~/Modules/Default/Empresa/EmpresaIndex.cshtml";
            }

            public static class Problema
            {
                public const string ProblemaIndex = "~/Modules/Default/Problema/ProblemaIndex.cshtml";
            }

            public static class Relato
            {
                public const string RelatoIndex = "~/Modules/Default/Relato/RelatoIndex.cshtml";
            }
        }
